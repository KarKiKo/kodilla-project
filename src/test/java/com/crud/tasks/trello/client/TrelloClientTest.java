...
public class TrelloClientTest {
        ...
        public void init(){
            ...
            when(trelloConfig.getTrelloUsername()).thenReturn("karola139");
        }
        @Test
        public void shouldFetchTrelloBoards() throws URISyntaxException {
            ...
            URI uri = new URI("http://test.com/members/karola139/boards?key=test&token=test&fields=name,id&lists=all");
